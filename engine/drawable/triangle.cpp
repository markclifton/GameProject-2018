...
Triangle::Triangle(glm::vec3 center)
{
    ...
    m_vertices[0].pos = glm::vec3(center.x - size, center.y - size, 0);
    m_vertices[1].pos = glm::vec3(center.x, center.y + size, 0);
    m_vertices[2].pos = glm::vec3(center.x + size, center.y - size, 0);
